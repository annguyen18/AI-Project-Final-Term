...
# # các encodings và names được lưu vào file encodings.pickle
...
#                 default="cnn", help="face detector to use: cnn or hog")
# args = vars(ap.parse_args())


def encodeFaces(folderName, detectionMethod):
    # lấy paths của images trong dataset
    imagesFolder = "attendancesystem" + "\\" + "dataset"
    encodedFile = "attendancesystem" + "\\" + "encodings.pickle"

    with open(encodedFile, "w") as f:
        pickle.dumps("")
